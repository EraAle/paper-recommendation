...
def main_crawling(search_query:str, limit: int = 50, date: list[int] = None, accept: bool = True) -> list[dict[str, any]]:
    # date가 없다면
    documents = []
    crawling_num = 0
    if date is None:
        ...
        documents = crawling_openreview_mix(search_query, limit, date, accept)
