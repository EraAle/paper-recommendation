...
# def crawling_openreview_v1_date(search_query: str, limit: int, date: list[int] = [2020, 2022], accept: bool = True) -> list[dict[str, any]]:
#     """
#     [구 버전 API] OpenReview에서 ~2022년까지의 논문을 페이징하여 검색합니다.
#     - limit이 100을 초과하면 100개씩 나누어 요청하고 3초씩 대기합니다.
#     """
...
# def crawling_openreview_v2_date(
#         search_query: str,
#         limit: int,
#         date: list[int] = [2023, 2025],
#         accept: bool = True
# ) -> list[dict[str, any]]:
#     """
#     [신 버전 API] OpenReview에서 특정 기간의 논문을 검색하고 accept 여부로 필터링합니다.
...
#         논문 정보 딕셔너리의 리스트
#     """
#     print(f"--- OpenReview v2 API로 검색을 시작합니다 ({date[0]}년 ~ {date[1]}년 데이터) ---")
#     documents = []
#     client = openreview.api.OpenReviewClient(baseurl='https://api2.openreview.net')
#
#     # 날짜 범위를 유닉스 타임스탬프(ms)로 변환
